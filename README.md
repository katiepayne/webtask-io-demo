...
-s TWILIO_USER=<Your-Twilio-UserKey> \
-s TWILIO_PASS=<Your-Twilio-PasswordKey> \
-s FROM_PHONE=<Phone-Number-Here> \
-s TO_PHONE=<Phone-Number-Here> \
-s MLAB_APIKEY=<mLab-API-Key> \
-s MLAB_DBNAME=<database-name-here> \
-s MLAB_COL=<mLab-collection-name> \
-s ERROR_KEY=<key-name-to-store-errors-in-mlab-db`>
